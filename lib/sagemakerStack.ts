...
export class SagemakerStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props: HuggingFaceLlmProps) {
    ...
    const isHuggingFaceHubModel =
      props.environmentVariables.HF_MODEL_ID !== undefined;
    ...
    const startUpHealthCheckTimeoutInSeconds =
    ...
    const bridgeEndpointConfig =
      sagemaker.EndpointConfig.fromEndpointConfigName(
        this,
    ...
    this.endpoint = new sagemaker.Endpoint(this, "HuggingFaceLlmEndpoint", {
      endpointName,
      endpointConfig: bridgeEndpointConfig,
    });
